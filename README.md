...
| Skill | Use |
| --- | --- |
| [`wow-logs`](.github/skills/wow-logs/SKILL.md) | Read and diagnose WoW client logs |
| [`wow-locate`](.github/skills/wow-locate/SKILL.md) | Last known in-game position |
| [`reflect-decision`](.github/skills/reflect-decision/SKILL.md) | Land a product decision in the docs |
